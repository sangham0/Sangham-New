...
export const essays: Essay[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "For all its excesses, America and the global culture it exported were not without their gifts. Alongside the plastic perfection and superficial mania, there were genuine contributions that deserve to be preserved. Rock and roll. The blues. A fierce insistence on individual expression. These were not trivial cultural artifacts. They carried something raw, rebellious, and human that should not be discarded simply because the larger structure that produced them is crumbling.",
      "Today, the primary battlefield is no longer physical territory, but consciousness itself. Social media and the digital sphere have become the dominant arenas through which values, identities, and desires are shaped. With artificial intelligence and quantum computing opening entirely new dimensions of influence, the forces competing for attention and allegiance are no longer merely ideological. They are psychological, emotional, and increasingly invisible.",
      ...
      "Even if the world goes up in smoke, and it is going up in smoke, there is a tremendous beauty to be found. Even as your own body is consumed by the funeral pyre, and it will be, there is beauty. Not because destruction is romantic, but because life has always been whole, even in its endings.",
