...
export const essays: Essay[] = [
  {
    ...
    paragraphs: [
      ...
      "It means, slowly, refusing to be a beggar in your own life. Not by force, not by performance, but by the simple, patient willingness to remember, again and again and again, that you were never small to begin with. There is a particular line, in some of the older mystical writings, that captures this better than any modern phrase has managed.",
